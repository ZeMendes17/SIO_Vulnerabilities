    ...
    for key in request.form:
        if key.startswith("order_again_"):
            ...
            for product in order_products:
                ...
                query = text("SELECT * FROM product WHERE id =" + str(product.product_id))
            ...
            return render_template("checkout.html", product_list=product_list, subtotal=subtotal, total=grand_total, shipping_cost=shipping_cost, number_of_items=number_of_items)
